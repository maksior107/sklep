...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  override def configure() {
    ...
    bind[SilhUserDAO].to[SilhUserDAOImpl]
  ...
  def provideOAuth1TokenSecretSigner(configuration: Configuration): Signer = {
    val config = configuration.get[JcaSignerSettings]("silhouette.oauth1TokenSecretProvider.signer")
  ...
  def provideOAuth1TokenSecretCrypter(configuration: Configuration): Crypter = {
    val config = configuration.get[JcaCrypterSettings]("silhouette.oauth1TokenSecretProvider.crypter")
  ...
  def provideAuthenticatorService(
    ...
    val config = configuration.get[CookieAuthenticatorSettings]("silhouette.authenticator")(ConfigLoader.)
  ...
  def provideOAuth1TokenSecretProvider(
    ...
    val settings = configuration.get[CookieSecretSettings]("silhouette.oauth1TokenSecretProvider")
  ...
  def provideFacebookProvider(
    ...
    new FacebookProvider(httpLayer, socialStateHandler, configuration.get[OAuth2Settings]("silhouette.facebook"))
  }
  ...
  def provideGoogleProvider(
    ...
    new GoogleProvider(httpLayer, socialStateHandler, configuration.get[OAuth2Settings]("silhouette.google"))
  }
  ...
  def provideVKProvider(
    ...
    new VKProvider(httpLayer, socialStateHandler, configuration.get[OAuth2Settings]("silhouette.vk"))
  }
  ...
  def provideTwitterProvider(
    ...
    val settings = configuration.get[OAuth1Settings]("silhouette.twitter")
  ...
  def provideXingProvider(
    ...
    val settings = configuration.get[OAuth1Settings]("silhouette.xing")
  ...
  def provideYahooProvider(
    ...
    val settings = configuration.get[OpenIDSettings]("silhouette.yahoo")
